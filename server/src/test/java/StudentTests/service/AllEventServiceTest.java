...
//        db.closeConnection(false);
    ...
    public void servicePass() throws DataAccessException {
        ...
        //Performing AllPerson tests
        AllEventServiceRequest req = new AllEventServiceRequest(loginResult.getAuthtoken());
        AllEventServiceResult res = AllEventService.allEvent(req);

        assertTrue(res.getData().contains(aaEvent));
        assertTrue(res.getData().contains(aEvent));
        assertFalse(res.getData().contains(bestEvent));
    ...
    public void serviceFail() throws DataAccessException {
        AllEventServiceResult result = AllEventService.allEvent(null);
