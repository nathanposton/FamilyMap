...
//        db.closeConnection(false);
    ...
    public void servicePass() throws DataAccessException {
        ...
        RegisterRequest request = new RegisterRequest(randomUsername, bestUser.getPassword(), bestUser.getEmail(),
                                                bestUser.getFirstName(), bestUser.getLastName(), bestUser.getGender());

        RegisterResult result = RegisterService.register(request);

        assertNotNull(result.getPersonID());
        assertEquals(randomUsername, result.getUsername());
    ...
    public void serviceFail() throws DataAccessException {
        RegisterResult result = RegisterService.register(null);
