...
//        db.clearTables();
        ...
        anotherEvent = new Event("another23event", "eventUser12", "Guy213",
                ...
                "Festival", 2666);
        aEvent = new Event("aEventID", "childUsername", "aEventPersonID",
                32.9f, 0.0f, "New Zealand", "Quoka",
                "aEventType", 2666);
        aaEvent = new Event("aaEventID", "childUsername", "aEventPersonID",
                32.9f, 0.0f, "New Zealand", "Quoka",
                "aEventType", 2666);
        bEvent = new Event("bEventID", "childUsername", "bEventPersonID",
                32.9f, 0.0f, "New Zealand", "Quoka",
                "bEventType", 2666);
        bbEvent = new Event("bbEventID", "childUsername", "bEventPersonID",
                32.9f, 0.0f, "New Zealand", "Quoka",
                "bEventType", 2666);
...
//        db.closeConnection(false);
    ...
    public void servicePass() throws DataAccessException {
        ...
        SingleEventServiceRequest req = new SingleEventServiceRequest(aaEvent.getEventID(), loginResult.getAuthtoken());
        SingleEventServiceResult res = SingleEventService.singleEvent(req);

        assertEquals(aaEvent.getAssociatedUsername(), res.getAssociatedUsername());
        assertEquals(aaEvent.getEventID(), res.getEventID());
        assertNotEquals(bEvent.getEventID(), res.getEventID());
    ...
    public void serviceFail() throws DataAccessException {
        SingleEventServiceResult result = SingleEventService.singleEvent(null);
