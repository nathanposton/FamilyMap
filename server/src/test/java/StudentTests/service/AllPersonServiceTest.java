...
//        db.closeConnection(false);
    ...
    public void servicePass() throws DataAccessException {
        ...
        AllPersonServiceRequest req = new AllPersonServiceRequest(loginResult.getAuthtoken());
        AllPersonServiceResult res = AllPersonService.allPerson(req);

        assertTrue(res.getData().contains(child));
        assertTrue(res.getData().contains(father));
        assertFalse(res.getData().contains(bestPerson));
    ...
    public void serviceFail() throws DataAccessException {
        AllPersonServiceResult result = AllPersonService.allPerson(null);
